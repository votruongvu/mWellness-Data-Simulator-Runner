...
> **ARTIFACT MIRROR — evidence copy, NOT canonical.** Per the Artifact truth rule,
> files under `.claude-framework/artifacts/` are evidence/history, not current
> truth. The **canonical** requirement source lives at
> [`docs/requirements/MOBILE_RUNNER_MASTER_REQ.html`](../../../docs/requirements/MOBILE_RUNNER_MASTER_REQ.html)
> and its conversion
> [`docs/requirements/MOBILE_RUNNER_MASTER_REQ.md`](../../../docs/requirements/MOBILE_RUNNER_MASTER_REQ.md).
> If this mirror diverges from the canonical docs, the canonical docs win.

---

> This Markdown is a faithful conversion of the canonical HTML document. The HTML
> and the `docs/` `.md` are the **single canonical requirement source** for
